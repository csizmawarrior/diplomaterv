...
public partial class trapGrammarParser : Parser {
	...
	public const int
		...
		RULE_enemySpawn = 11, RULE_teleport = 12, RULE_rangeDeclaration = 13, 
		RULE_moveRoundDeclaration = 14;
	public static readonly string[] ruleNames = {
		"definition", "name", "statementList", "statement", "place", "nameDeclaration", 
		"effectDeclaration", "circleMove", "effect", "damage", "heal", "enemySpawn", 
	...
	public partial class EffectContext : ParserRuleContext {
		...
		public EnemySpawnContext enemySpawn() {
			return GetRuleContext<EnemySpawnContext>(0);
		}
	...
	public partial class EnemySpawnContext : ParserRuleContext {
		...
		public override int RuleIndex { get { return RULE_enemySpawn; } }
		public override void EnterRule(IParseTreeListener listener) {
			ItrapGrammarListener typedListener = listener as ItrapGrammarListener;
			if (typedListener != null) typedListener.EnterEnemySpawn(this);
		}
		public override void ExitRule(IParseTreeListener listener) {
			ItrapGrammarListener typedListener = listener as ItrapGrammarListener;
			if (typedListener != null) typedListener.ExitEnemySpawn(this);
		}
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ItrapGrammarVisitor<TResult> typedVisitor = visitor as ItrapGrammarVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitEnemySpawn(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	[RuleVersion(0)]
	public EnemySpawnContext enemySpawn() {
		EnemySpawnContext _localctx = new EnemySpawnContext(_ctx, State);
		EnterRule(_localctx, 22, RULE_enemySpawn);
		try {
			EnterOuterAlt(_localctx, 1);
			{
