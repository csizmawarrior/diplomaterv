...
public partial class DynamicEnemyGrammarParser : Parser {
	public const int
		...
		COLON=40, SEMI=41, COMMA=42, DOT=43, NUMBER=44, ID=45, WS=46, TELEPORT_t=47, 
		ATTRIBUTE=48;
	public const int
	...
	private static readonly string[] _SymbolicNames = {
		...
		"COLON", "SEMI", "COMMA", "DOT", "NUMBER", "ID", "WS", "TELEPORT_t", "ATTRIBUTE"
	};
	...
	public StatementListContext statementList() {
		...
		try {
			...
			_errHandler.Sync(this);
			_la = _input.La(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TELEPORT_PLACE) | (1L << SPAWN_PLACE) | (1L << SPAWN_TYPE) | (1L << DAMAGE) | (1L << IF) | (1L << WHILE) | (1L << HEALTH) | (1L << MOVE) | (1L << SHOOT) | (1L << SPAWN) | (1L << TELEPORT_T) | (1L << HEAL) | (1L << TELEPORT_t))) != 0)) {
				{
				{
				State = 71; statement();
				}
	...
	public NameDeclarationContext nameDeclaration() {
		...
		try {
			...
			case TRAP:
				EnterOuterAlt(_localctx, 1);
				{
				State = 118; trapNameDeclaration();
				}
				break;
			case MONSTER:
				EnterOuterAlt(_localctx, 2);
				{
				State = 119; monsterNameDeclaration();
				}
				break;
			default:
	...
	public TrapNameDeclarationContext trapNameDeclaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 122; Match(TRAP);
			State = 123; Match(NAME_T);
	...
	public MonsterNameDeclarationContext monsterNameDeclaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 128; Match(MONSTER);
			State = 129; Match(NAME_T);
	...
	public TeleportPointDeclarationContext teleportPointDeclaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 146; Match(TELEPORT_PLACE);
	...
	public SpawnPointDeclarationContext spawnPointDeclaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 150; Match(SPAWN_PLACE);
			State = 151; Match(EQUALS);
			State = 152; place();
			}
		}
		catch (RecognitionException re) {
	...
	public MoveDeclarationContext moveDeclaration() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 162; Match(MOVE);
				State = 163; Match(DIRECTION);
				}
				break;
	...
	public ShootDeclarationContext shootDeclaration() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 178; Match(SHOOT);
				State = 179; Match(DIRECTION);
				}
				break;
	...
	public DamageDeclarationContext damageDeclaration() {
		...
		try {
			...
			case 4:
				...
				State = 221; damageAmountDeclaration();
				}
				break;
			...
			case 7:
				...
				State = 229; Match(TO);
				State = 230; place();
				State = 231; damageAmountDeclaration();
				}
				break;
			...
			case 9:
				...
				State = 237; Match(TO);
				State = 238; character();
				State = 239; damageAmountDeclaration();
				}
				break;
			}
		}
	...
	public HealDeclarationContext healDeclaration() {
		...
		try {
			...
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 245; Match(HEAL);
				State = 246; Match(DIRECTION);
				State = 247; healAmountDeclaration();
				}
				break;
			...
			case 4:
				...
				State = 254; healAmountDeclaration();
				}
				break;
			...
			case 7:
				...
				State = 262; Match(TO);
				State = 263; place();
				State = 264; healAmountDeclaration();
				}
				break;
			...
			case 9:
				...
				State = 270; Match(TO);
				State = 271; character();
				State = 272; healAmountDeclaration();
				}
				break;
			}
		}
	...
	public SpawnDeclarationContext spawnDeclaration() {
		...
		try {
			...
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 282; Match(SPAWN);
				State = 283; Match(RANDOM);
				}
				break;
			...
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 284; Match(SPAWN);
				State = 285; Match(MONSTER);
				State = 286; name();
				}
				break;
	...
	public IfexpressionContext ifexpression() {
		...
		try {
			...
			{
			State = 310; Match(IF);
			State = 311; Match(PARENTHESISSTART);
			State = 312; expression(0);
			State = 313; Match(PARENTHESISCLOSE);
			State = 314; block();
			}
		}
		catch (RecognitionException re) {
	...
	public WhileexpressionContext whileexpression() {
		...
		try {
			...
			State = 317; Match(PARENTHESISSTART);
			State = 318; expression(0);
			State = 319; Match(PARENTHESISCLOSE);
			State = 320; block();
			}
		}
		catch (RecognitionException re) {
	...
	private ExpressionContext expression(int _p) {
		...
		try {
			...
			case PARENTHESISSTART:
				{
				State = 344; Match(PARENTHESISSTART);
				State = 345; expression(0);
				State = 346; Match(PARENTHESISCLOSE);
				}
				break;
			case ABSOLUTE:
				{
				State = 348; Match(ABSOLUTE);
				State = 349; expression(0);
				State = 350; Match(ABSOLUTE);
				}
				break;
			case NOTHING:
			case TRAP:
			...
			case NEGATE:
				{
				State = 353; Match(NEGATE);
				State = 354; expression(1);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public SomethingContext something() {
		...
		try {
			...
			case ID:
				EnterOuterAlt(_localctx, 4);
				{
				State = 369; possibleAttributes();
				}
				break;
			case NOTHING:
				EnterOuterAlt(_localctx, 5);
				{
				State = 370; Match(NOTHING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public OperationContext operation() {
		...
		try {
			...
			case ATTRIBUTE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 373; Match(ATTRIBUTE);
				}
				break;
			case NUMCONNECTER:
				EnterOuterAlt(_localctx, 2);
				{
				State = 374; Match(NUMCONNECTER);
				}
				break;
			case BOOLCONNECTER:
				EnterOuterAlt(_localctx, 3);
				{
				State = 375; Match(BOOLCONNECTER);
				}
				break;
			case COMPARE:
				EnterOuterAlt(_localctx, 4);
				{
				State = 376; Match(COMPARE);
				}
				break;
			case ALIVE:
				EnterOuterAlt(_localctx, 5);
				{
				State = 377; Match(ALIVE);
				}
				break;
			case IS:
				EnterOuterAlt(_localctx, 6);
				{
				State = 378; Match(IS);
				State = 379; Match(NEAR);
				}
				break;
			case NUMCOMPARE:
				EnterOuterAlt(_localctx, 7);
				{
				State = 380; Match(NUMCOMPARE);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static readonly string _serializedATN =
		"\x3\xAF6F\x8320\x479D\xB75C\x4880\x1605\x191C\xAB37\x3\x32\x182\x4\x2"+
		...
		"\x3\x5\x3\x5\x3\x5\x3\x5\x3\x5\x3\x5\x3\x5\x5\x5w\n\x5\x3\x6\x3\x6\x5"+
		...
		"\x3\x10\x3\x10\x3\x10\x3\x10\x3\x10\x5\x10\xB3\n\x10\x3\x11\x3\x11\x3"+
		"\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3"+
		"\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3"+
		"\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x3\x11\x5\x11\xD3\n\x11"+
		...
		"\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3\x13\x3"+
		"\x13\x3\x13\x3\x13\x3\x13\x3\x13\x5\x13\x115\n\x13\x3\x14\x3\x14\x3\x14"+
		...
		"\x15\x137\n\x15\x3\x16\x3\x16\x3\x16\x3\x16\x3\x16\x3\x16\x3\x17\x3\x17"+
		"\x3\x17\x3\x17\x3\x17\x3\x17\x3\x18\x3\x18\a\x18\x147\n\x18\f\x18\xE\x18"+
		"\x14A\v\x18\x3\x18\x3\x18\x3\x19\x3\x19\x3\x1A\x3\x1A\x3\x1B\x3\x1B\x3"+
		"\x1B\x3\x1B\x3\x1C\x3\x1C\x3\x1D\x3\x1D\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x3"+
		"\x1E\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x5\x1E\x166\n\x1E"+
		"\x3\x1E\x3\x1E\x3\x1E\x3\x1E\a\x1E\x16C\n\x1E\f\x1E\xE\x1E\x16F\v\x1E"+
		...
		"\x2>\x2\x2\x3\x4\x2\f\xE\x13\x13\x1A4\x2\x43\x3\x2\x2\x2\x4\x46\x3\x2"+
		"\x2\x2\x6H\x3\x2\x2\x2\bv\x3\x2\x2\x2\nz\x3\x2\x2\x2\f|\x3\x2\x2\x2\xE"+
		"\x82\x3\x2\x2\x2\x10\x88\x3\x2\x2\x2\x12\x8C\x3\x2\x2\x2\x14\x90\x3\x2"+
		"\x2\x2\x16\x94\x3\x2\x2\x2\x18\x98\x3\x2\x2\x2\x1A\x9C\x3\x2\x2\x2\x1C"+
		"\xA0\x3\x2\x2\x2\x1E\xB2\x3\x2\x2\x2 \xD2\x3\x2\x2\x2\"\xF3\x3\x2\x2\x2"+
		"$\x114\x3\x2\x2\x2&\x125\x3\x2\x2\x2(\x136\x3\x2\x2\x2*\x138\x3\x2\x2"+
		"\x2,\x13E\x3\x2\x2\x2.\x144\x3\x2\x2\x2\x30\x14D\x3\x2\x2\x2\x32\x14F"+
